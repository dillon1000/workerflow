...
- Normal plugin additions should not require edits to `src/lib/workflow/templates.ts`, `worker/services/runtime.ts`, or `worker/routes/triggers.ts`.
...
- For more information, refer to docs/PLUGIN_DEVELOPMENT.md
